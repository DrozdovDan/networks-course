...
1. Каков IP-адрес вашего хоста? Каков IP-адрес хоста назначения?
   ...
   - Destination: 104.243.42.233
   - ![icmp1](./screens/icmp1.png)
2. Почему ICMP-пакет не обладает номерами исходного и конечного портов?
   - Это протокол сетевого уровня, а порты используются на транспортном уровне.
3. Рассмотрите один из ping-запросов, отправленных вашим хостом. Каковы ICMP-тип и кодовый
   ...
   - По 2 байта на каждое из полей Checksum, Identifier, Sequence Number.
   - ![icmp2](./screens/icmp2.png)
...
2. Рассмотрите на вашем скриншоте ICMP-пакет с сообщением об ошибке. В нем больше полей,
   ...
   - Добавляются поля: Unused, Length — длина исходного сообщения, UDP — информация об исходном сообщении.
   - ![tr2](./screens/tr2.png)
3. Рассмотрите три последних ICMP-пакета, полученных исходным хостом. Чем эти пакеты
   ...
   - Они не имеют дополнительных полей, описанных в п. 2.
   - Это произошло, потому что эти сообщения дошли до адресата.
   - ![tr3](./screens/tr3.png)
4. Есть ли такой канал, задержка в котором существенно превышает среднее значение? Можете
   ...
   - На шаге 10 мы, кажется, прыгаем из Фремонта (Калифорния, США) в Хельсинки (Финляндия).
   - ![tr4](./screens/tr4.png)
...
#### Демонстрация работы
![ipmask1](./screens/ipmask1.png)
![ipmask2](./screens/ipmask2.png)
...
#### Демонстрация работы
![copiescounter](./screens/copiescounter.png)
