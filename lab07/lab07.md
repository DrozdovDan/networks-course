...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - Sequence Number: 0    (relative sequence number), Sequence Number (raw): 1905471814. То, что это SYN написано во флагах.
   - ![tcp3](./screens/tcp3.png)
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - Sequence Number: 0    (relative sequence number), Sequence Number (raw): 1500381875.
   - Acknowledgment Number: 1    (relative ack number), Acknowledgment number (raw): 3745069955.
   - Ack number = Seq number Ack пакета + 1.
   - Флаги [SYN, ACK].
   - ![tcp4](./screens/tcp4.png)
5. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   - Sequence Number: 1    (relative sequence number), Sequence Number (raw): 3745069955.
   - ![tcp5](./screens/tcp5.png)
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - Номера: 1, 634, 13774, 15234, 35674, 41514
   - Время отправки: 2.251713 - 2.631679
   - Время ответа: 2.396000 - 2.633845
   - RTT: UNK + 0.144165 + 0.003386 + 0.234739 + 0.234241 + 0.002166
   - ![tcp6](./screens/tcp6.png)
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - Window size / mean RTT = 65280 / 0.1237376 = 527568 б/с = 0.5 кб/c
...
#### Демонстрация работы
![udpclient1](./screens/udpclient1.png)
![udpserver1](./screens/udpserver1.png)
...
#### Демонстрация работы
![udpclient2](./screens/udpclient2.png)
...
#### Демонстрация работы
![heartbeatserver](./screens/heartbeatserver.png)
![heartbeatclient1](./screens/heartbeatclient1.png)
![heartbeatclient2](./screens/heartbeatclient2.png)
