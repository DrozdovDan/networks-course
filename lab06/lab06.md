...
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   ...
   - Source Port и Destination Port поменялись местами.
...
#### Демонстрация работы
![ftp2.1](./screens/ftp2.1.png)
![ftp2.2](./screens/ftp2.2.png)
